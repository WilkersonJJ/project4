...
class ExactInference(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        pacmanPosition = gameState.getPacmanPosition()
        allPositions = self.allPositions
        #newBelief = self.beliefs
        newBelief = DiscreteDistribution()
        #for each possible position, get the new distribution, and iterate through to update
        for oldPos in allPositions:
            newPosDist = self.getPositionDistribution(gameState, oldPos)
            oldValue = self.beliefs[oldPos]
            for newPos in newPosDist:
                newValue = newPosDist[newPos]
                newBelief[newPos] += oldValue * newValue
